...
public class AppDbContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
{
  ...
  protected override void OnModelCreating(ModelBuilder builder)
  {
    ...
    // ══════════════════════════════════════════════════════════════
    // 6. Story
    //    - Một story = một media (ảnh/video) + metadata 24 giờ
    //    - Index Non-Clustered trên IdTaiKhoan, CreatedAt, ExpiresAt
    // ══════════════════════════════════════════════════════════════
    builder.Entity<Story>(entity =>
    {
      ...
      entity.Property(s => s.MediaUrl)
                .HasMaxLength(1000)
                .IsRequired();

      entity.Property(s => s.MediaType)
                .HasConversion<string>()
                .HasMaxLength(10)
                .IsRequired();

      entity.Property(s => s.Caption)
                .HasMaxLength(300);
