...
namespace InteractHub_API.Migrations
{
    ...
    [Migration("20260502020745_AddProfilePropertiesToUser")]
    partial class AddProfilePropertiesToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Friendship", b =>
                {
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Like", b =>
                {
                    b.Property<string>("IdTaiKhoan")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Post", b =>
                {
                    b.Property<string>("IdPost")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.PostHashtag", b =>
                {
                    b.Property<string>("IdPost")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.PostMedia", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.PostReport", b =>
                {
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Story", b =>
                {
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Comment", b =>
                {
                    b.HasOne("InteractHub_API.Data.Entities.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("IdPost")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InteractHub_API.Data.Entities.ApplicationUser", "TaiKhoan")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Friendship", b =>
                {
                    b.HasOne("InteractHub_API.Data.Entities.ApplicationUser", "NguoiGui")
                        .WithMany("SentFriendships")
                        .HasForeignKey("IdNguoiGui")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InteractHub_API.Data.Entities.ApplicationUser", "NguoiNhan")
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("InteractHub_API.Data.Entities.ApplicationUser", "TriggeredByUser")
            ...
            modelBuilder.Entity("InteractHub_API.Data.Entities.PostHashtag", b =>
                {
                    b.HasOne("InteractHub_API.Data.Entities.Hashtag", "Hashtag")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InteractHub_API.Data.Entities.ApplicationUser", null)
                        .WithMany()
