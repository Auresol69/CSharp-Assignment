    ...
    <>
      <div className="fixed inset-0 bg-black/60 z-9999 flex items-end sm:items-center justify-center sm:p-4 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-4 sm:p-6 space-y-8 overflow-y-auto flex-1 custom-scrollbar">
            {/* Media Section */}
            ...
            <div className="pt-4">
              ...
              <textarea 
                ...
                placeholder="Mô tả về bản thân ông nè..."
              />
            </div>
          ...
          <div className="p-4 border-t bg-gray-50 flex gap-3 sticky bottom-0">
            ...
            <button className="flex-1 py-3 bg-blue-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 shadow-lg shadow-blue-100 active:scale-95 transition-all text-sm sm:text-base">
